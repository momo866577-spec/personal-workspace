const CACHE="workspace-v6"; const ASSETS=["/","/manifest.webmanifest","/icons/icon-192.png","/icons/icon-512.png","/icons/apple-touch-icon.png","/mascots/pink-rabbit.png","/mascots/blue-fox.png"];
